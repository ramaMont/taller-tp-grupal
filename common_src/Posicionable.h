...
public:
	...
	// Tira excepcion, los objetos con los que colisiono solo pueden 
    // ser clases hijas de Posicionable.
    virtual void colisioned(Ray* ray,Coordinates coordinates_map,
        bool first_triangle);
    ...
    // En ningun otro objeto ademas de SpriteHolder puedo tener otro 
    // Posicionable adentro
