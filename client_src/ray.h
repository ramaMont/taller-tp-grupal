...
const double PI= 3.14159265358979323;
	...
	private:
		...
		// Calcula la distancia desde el jugador al objeto con el que impactó
		// el rayo
		double get_distance_to_player_plane(
		...
		pared), y se fija si toca un objeto, caso contrario, se llama a si
		misma con ésta nueva posicion*/
	...
	public:
		// Ray angle y ray_direction NO es lo mismo, la primera es relativa 
		// al plano de la camara y la segunda NO
		...
		el que choca el rayo, partiendo de la posicion inicial,
		player_position*/
