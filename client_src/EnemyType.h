...
public:
	explicit EnemyType(Texture *texture_drawer, CharacterType enemy_type);
    ...
    //Pre:-
    // Actualiza el frame de disparo, si es 0 no estoy disparando, si es 10 
	// terminé de disparar
	void updateShooting();
...
public:
	explicit Dog(Texture *texture_drawer);
	virtual void callDrawer(int first_x_pixel,int first_number_line_texture,
		int last_x_pixel, int last_number_line_texture, 
		float distance_player_plane, int texture, int state) override;
...
public:
	explicit Guard(Texture *texture_drawer);
	virtual void callDrawer(int first_x_pixel, int first_number_line_texture,
		int last_x_pixel, int last_number_line_texture, 
		float distance_player_plane, int texture, int state) override;
	virtual void shoot(SoundPlayer& soundPlayer, float distance) override;
...
public:
	explicit SS(Texture *texture_drawer);
	virtual void callDrawer(int first_x_pixel, int first_number_line_texture,
		int last_x_pixel, int last_number_line_texture,
		float distance_player_plane, int texture, int state) override;
	virtual void shoot(SoundPlayer& soundPlayer, float distance) override;
...
public:
	explicit Officer(Texture *texture_drawer);
	virtual void callDrawer(int first_x_pixel, int first_number_line_texture,
		int last_x_pixel, int last_number_line_texture,
		float distance_player_plane, int texture, int state) override;
	virtual void shoot(SoundPlayer& soundPlayer, float distance) override;
...
public:
	explicit Mutant(Texture *texture_drawer);
	virtual void callDrawer(int first_x_pixel, int first_number_line_texture,
		int last_x_pixel, int last_number_line_texture,
		float distance_player_plane, int texture, int state) override;
	virtual void shoot(SoundPlayer& soundPlayer, float distance) override;
